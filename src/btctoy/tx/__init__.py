...
class Tx:
    ...
    def fee(self) -> int:
        ...
        for tx in self.tx_ins:
            input_sum += tx.value(self.testnet)
    ...
    def verify(self) -> bool:
        ...
        if self.fee() < 0 or self.fee == None:  # <1>
            return False
