...
def make_private_key(passphrase: str) -> PrivateKey:
    ...
    bin_passphrase = passphrase.encode()
    secret = little_endian_to_int(hash256(bin_passphrase))
...
# XPa
# Command used for send transaction : btctoy send aceabd58d14b8b42abec5a8fa5464a2a682c07b2323f09d9dfd22744d1320d8c 1
# Hash of transaction : cfc7d03ffd0e928a7febadfb9196434a3de7b299e495c0f3d111cb52e1244924
@app.command()
def send(
    ctx: click.Context,
    input_tx_id: str,
    ...
    tx = Tx(1, [tx_in], [tx_out_0, tx_out_1], 0, True)
